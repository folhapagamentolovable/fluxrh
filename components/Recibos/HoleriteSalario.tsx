...
import { mapearFolhaParaHoleriteSalario, formatarMoeda } from './codigosContabeisSalario';
import { obterPeriodoFolhaPonto } from '../../utils/periodoFolhaPonto';

interface HoleriteSalarioProps {
  funcionario: any;
  empresa: any;
  resultado: any;
  mes: number;
...
const HoleriteSalario: React.FC<HoleriteSalarioProps> = ({
  funcionario,
  empresa,
  resultado,
  mes,
  ...
  // Mapear dados para lançamentos (SEM benefícios e SEM itens de 13°)
  const lancamentos = mapearFolhaParaHoleriteSalario(resultado, eventosExcepcionais, folhaPonto, parametros);
  
  // Calcular totais a partir dos lançamentos
  ...
  return (
    <div className="bg-white overflow-x-auto" id="holerite-salario-print" style={{ width: '100%', minHeight: 'auto', fontSize: '8px', padding: '0', boxSizing: 'border-box', marginTop: '10px' }}>
...
export default HoleriteSalario;
