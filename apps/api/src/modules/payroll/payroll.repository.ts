...
const tables: PayrollOverview["legalTables"] = [
  {
    ...
    brackets: [
      { from: 0, to: 1518, rate: 7.5, deduction: 0 },
      { from: 1518.01, to: 2793.88, rate: 9, deduction: 22.77 },
      { from: 2793.89, to: 4190.83, rate: 12, deduction: 106.59 },
      { from: 4190.84, to: 8157.41, rate: 14, deduction: 190.4 },
    ],
  },
  {
    id: "irrf_2026",
